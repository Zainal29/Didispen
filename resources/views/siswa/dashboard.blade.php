...
@if(isset($dispensasiAktif))
    ...
    <div class="bg-emerald-50 rounded-2xl border-2 border-emerald-200 shadow-sm p-4 mb-4">
        <div class="flex items-center gap-3">
            <div class="w-12 h-12 rounded-full bg-emerald-500 text-white flex items-center justify-center flex-shrink-0">
                <i class="fas fa-check-circle text-xl"></i>
            </div>
            <div class="min-w-0">
                <h3 class="font-bold text-emerald-800">Dispensasi Selesai</h3>
